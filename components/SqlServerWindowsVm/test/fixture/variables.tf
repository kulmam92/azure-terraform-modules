...
variable "vm_os_simple" {
  description = "Specify UbuntuServer, WindowsServer, and CentOS to get the latest image version of the specified os.  Do not provide this value if a custom value is used for vm_os_publisher, vm_os_offer, and vm_os_sku."
  default     = ""
}
